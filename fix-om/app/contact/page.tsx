    ...
    <div className="min-h-screen bg-obsidian">
      ...
      <main id="main-content" className="mx-auto max-w-4xl px-4 pb-16 pt-24 sm:px-6">
        ...
        >
          {channels.map((channel) => (
            <motion.a
              ...
              whileHover={{ y: -3 }}
              whileTap={{ scale: 0.98 }}
              className="flex flex-col items-center rounded-2xl border border-glass-border bg-surface p-5 text-center shadow-soft transition-shadow hover:shadow-card md:p-6"
            >
        ...
        <Reveal className="mt-10 overflow-hidden rounded-2xl border border-glass-border bg-surface shadow-soft">
          <div className="relative aspect-[21/9] max-h-[180px] w-full">
            <Image
